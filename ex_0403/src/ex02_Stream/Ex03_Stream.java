...
public class Ex03_Stream {
	...
	public static void main(String[] args) {
		// 1. forEach() : 모든 요소에 대해 작업 수행(보통 출력용)
		Stream.of("A", "B", "C")
		...
		// 2. collect() : 스트림을 List, Set, Map 등으로 모을 때 사용
		List<String> result = Stream.of("apple", "banana")
									.collect(Collectors.toList());
		
		
		
		// 3. count() : 요소의 개수를 long 타입으로 반환
		...
		// 7. allMatch() : 모든 요소가 조건을 만족하는지 판별
		boolean allLong = Stream.of("Java", "Go", "Python")
		...
		// 8. reduce() : 스트림 요소를 누적해서 하나의 값으로 줄인다. (합계, 곱, 문자열 결합 등)
		...
		System.out.println("list의 모든 요소의 총합 : " + sum);
		
		
		// IntSteam 과 같은 기본형 스트림에는 스트림의 요소들에 대한 통계 정보를
		// 얻을 수 있는 메서드들이 있다.
