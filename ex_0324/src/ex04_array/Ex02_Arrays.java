...
public class Ex02_Arrays {
	...
	public static void main(String[] args) {
		// Arrays 클래스는 배열의 복사, 항목의 정려르 항목 검색 등
		...
		// 1. 배열의 출력
		// toString() : 반복문의 도움 없이 배열을 출력할 수 있도록 도와준다.
		...
		// 하지만 기본 자료형 배열로는 불가능
		// 기본 자료형의 클래스 타입인 Wrapper 클래스를 이용한다.
		...
		// 배열을 복사하는 방법에는 얕은 복사, 깊은 복사 두 가지가 있다.
		...
		// < 얕은 복사 : 주소를 복사 >
		System.out.println("< 얕은 복사 : 주소를 복사 >");
		int[] arr01 = {1,2,3};
		// arr01은 배열 {1,2,3}의 주소값을 가지고 있다.
		
		System.out.println("arr01은 배열 {1,2,3}의 주소값을 가지고 있다. " + arr01); //[I@15975490
		...
		// < 깊은 복사 : 값을 복사 >
		// 배열의 깊은 복사는 반복문을 통해 새로운 배열에 값으 직접 넣어주거나
		// Arrays 클래스 또는 System 클래스가 가진 기능을 이용한다.
		System.out.println("< 깊은 복사 : 값을 복사 >");
