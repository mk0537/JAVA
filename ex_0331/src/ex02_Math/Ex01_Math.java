...
public class Ex01_Math {
	...
	public static void main(String[] args) {
		...
		// 객체를 선언하지 않고 바로 사용할 수 잇도록 해당 클래스가 제공하는
		// 모든 메서드는 정적 메서드로 이루어져 있다.
		...
		// random() : 난수 생성 (0.0 이상 1.0 미만의 double 형 난수)
		System.out.println((int)(Math.random()*100)); // 정수형 두자리 난수 생성
