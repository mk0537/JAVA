...
public class Ex01_Calendar {
	...
	public static void main(String[] args) {
		...
		int month = cal.get(Calendar.MONTH)+1; // 0 ~ 11월 까지 들어있어서 +1
		...
		// DateTimeFormatter -> java.time 패키지에 있는 클래스
		// 날짜나 시간을 문자열로 변경해줄 수 있고 
		// 반대로 문자열로 된 시간을 날짜/시간 타입으로 변경해줄 수 있다.
